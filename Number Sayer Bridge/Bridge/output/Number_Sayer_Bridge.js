(function (globals) {
    ...
    Bridge.define('Number_Sayer_Bridge.NumberSayer', {
        ...
        [Number_Sayer_Bridge.NumberSayer.Language.Spanish, ["Ana"]]
    ] );
        ...
        say: function (value) {
            ...
            while (true) {
                ...
                if (currentVal.neq(0)) {
                    ...
                    result.appendThis(currentVal.eq(1) ? this.loadSound("one") : this.say(currentVal));
                    if (!condition) {
                        result.appendThis(this.loadSound(languageNumberScale.eq(1000) ? Number_Sayer_Bridge.NumberSayer.placeValues[n] : Number_Sayer_Bridge.NumberSayer.placeValues[((n + 1) | 0)]));
                        if (this.language === Number_Sayer_Bridge.NumberSayer.Language.Spanish && currentVal.neq(1)) {
