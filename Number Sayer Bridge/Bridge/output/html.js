(function (globals) {
    ...
    Bridge.define('Number_Sayer_Bridge.HTML', {
        statics: {
            ...
            start: function () {
                var $t;
                Number_Sayer_Bridge.HTML.getnumber().onkeydown = $_.Number_Sayer_Bridge.HTML.f1;
    
                Number_Sayer_Bridge.HTML.getlanguage().onchange = $_.Number_Sayer_Bridge.HTML.f2;
    
                document.getElementById("submit").onclick = Number_Sayer_Bridge.HTML.submit;
    
                Number_Sayer_Bridge.HTML.getlanguage().innerHTML = "";
